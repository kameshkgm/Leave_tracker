...
import './ManagerPage.css'; // Assuming the custom CSS file for additional styling
...
const ManagerPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:3001/login', { email, password, role: 'manager' });
  ...
  return (
    <div className="employee-page-container">
      <div className="employee-page-content">
        <h2 className="employee-page-title">Manager Login</h2>
